...
void solve(){
    // Observation [...]
    /* 
		Alright, let's search for permutations;
		We'll do this goofy ahh stuff, in a particular way. Let's find that way;
		0 1 2 3 4    (n = 5)
		0 3 1 4 2    (ith object at position 2*i % n)

		Let's check for n = 3;
		0 1 2
		0 2 1

		For even numbers, this technique always fails for some reason; duh this shit; let's try it that way only;
		Let's try to find a way for even n; Maybe it can be proven that no such solution exists for n = even;
    */
